      ...
      return (
        <div className="projects-grid">
          ...
          <Card shadow={5}>
            ...
            <CardText>
              <p> I have developed a website to learn to use web API. It was to challenge myself as I never worked with web API before.
              The website has a search function where we can insert one or many IMDB IDs. When a IMDB ID is inserted for the first time,
              a web API  is used to bring information from the third party website. Once a IMDB is checked  for the first time, the data is
              stored in the backend of local website. It means that when a IMDB ID is inserted for the second time, the data comes from the
                  local backend, not the third party website. </p>
